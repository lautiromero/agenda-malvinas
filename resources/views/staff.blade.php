    ...
    <div class="custom-container pb-4 md:py-12 md:w-3/4 mx-auto">
        ...
        <div class="grid md:grid-cols-3 gap-x-20 gap-y-14 pt-14 md:pt-16">
            <div class="pt-6 md:pt-0">
                <div class="pb-3">
                    <div class="text-cyan-600 inline-block text-2xl px-5 py-1 rounded-lg border-2 border-cyan-500 font-extrabold font-heading uppercase">Director</div>
                </div>
                <ul class="px-1">
                    <li class="font-medium text-2xl text-slate-700">Daniel Guzmán</li>
                </ul>
            </div>
            <div class="pt-6 md:pt-0">
                <div class="pb-3">
                    <div class="text-cyan-600 inline-block text-2xl px-5 py-1 rounded-lg border-2 border-cyan-500 font-extrabold font-heading uppercase">Editores</div>
                </div>
                <ul class="px-1">
                    <li class="font-medium text-2xl text-slate-700">Alejandro Betts</li>
                </ul>
                <ul class="px-1">
                    <li class="font-medium text-2xl text-slate-700">Mario Volpe</li>
                </ul>
                <ul class="px-1">
                    <li class="font-medium text-2xl text-slate-700">Lucio Verdoia</li>
                </ul>
                <ul class="px-1">
                    <li class="font-medium text-2xl text-slate-700">Moisés Solorza</li>
                </ul>
                <ul class="px-1">
                    <li class="font-medium text-2xl text-slate-700">Jerónimo Guerrero Iraola</li>
                </ul>
            </div>
            <div class="pt-6 md:pt-0">
                <div class="pb-3">
                    <div class="text-cyan-600 inline-block text-2xl px-5 py-1 rounded-lg border-2 border-cyan-500 font-extrabold font-heading uppercase">Relaciones Inst.</div>
                </div>
                <ul class="px-1">
                    <li class="font-medium text-2xl text-slate-700">Bruno Bustamante</li>
                </ul>
                <ul class="px-1">
                    <li class="font-medium text-2xl text-slate-700">Lucia Gala García Valls</li>
                </ul>
            </div>
            <div class="pt-6 md:pt-0">
                <div class="pb-3">
                    <div class="text-cyan-600 inline-block text-2xl px-5 py-1 rounded-lg border-2 border-cyan-500 font-extrabold font-heading uppercase">Redes sociales</div>
                </div>
                <ul class="px-1">
                    <li class="font-medium text-2xl text-slate-700">Pablo Abba</li>
                </ul>
            </div>
            <div class="pt-6 md:pt-0">
                <div class="pb-3">
                    <div class="text-cyan-600 inline-block text-2xl px-5 py-1 rounded-lg border-2 border-cyan-500 font-extrabold font-heading uppercase">Diseño & desarrollos</div>
                </div>
                <ul class="px-1">
                    <li class="font-medium text-2xl text-slate-700">Correa Marco Federico</li>
                </ul>
            </div>
        </div>
