        ...
        <div class="w-full sm:w-5/6">
            ...
            @if ($more->count())
                ...
                <div class="py-3 pt-5 border-b border-gray-300">
                    <h2 class="text-3xl font-extrabold font-heading">Más con el tag <strong class="uppercase text-2xl text-cyan-500 pl-2">{{ $name }}</strong></h2>
                </div>
        ...
        <div class="hidden sm:block w-1/6">
            ...
            <div class="py-2">
                <h4 class="text-2xl font-extrabold font-heading
                 pb-3 border-b boder-gray-300">Mas leídas de <span class="text-cyan-500">{{ $name }}</span></h4>
